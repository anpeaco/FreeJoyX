...
typedef struct
{
	...
	/* DEPRECATED (wire gen 0x0060): shift modifiers moved to shift_buttons[] at the
	 ...
	 * 0x0050->0x0060 migrator copies it into shift_buttons[]. */
	 ...
	 * Appended last so 0x0050 -> 0x0060 stays a prefix-copy migration. */
